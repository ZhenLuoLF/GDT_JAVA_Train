         ...
         while(true){
            if(u == null){
               ...
               switch (action) {
                  ...
                  case 8:
                     scanner.nextLine();
                     System.out.println("Please input the user name you want to assgined:");
                     String userName = scanner.nextLine();
                     ts.assignTaskToUser(userName);
                     break;
                  case 9:
                     u = null;
                     break;
               ...
               switch (action) {
                  ...
                  case 2:
                     ...
                     ts.markTaskCompleted(taskId);
                     break;
                  case 3:
                     ts.printTaskByUserAndCompeletiong(u.getName());
                     break;
                  case 4:
                     u = null;
                     break;
